...
const Hero = () => {
  ...
  return (
    <div className="lg:pb-20 lg:pt-36 pb-10 pt-24">
      {/**
       *  UI: Spotlights
       ...
       */}
      <div
        className="h-screen w-full dark:bg-black-100 bg-slate-50 dark:bg-grid-white/[0.03] bg-grid-black-100/[0.2]
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Bakate, a full-stack developer based in Paris.
          </p>
